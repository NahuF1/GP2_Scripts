...
def regionExtractor(HAR, chrom, startBP, endBP, sets, PATH_GENO, ANCESTRY, exceptions_file, lock):
    ...
    inputRawFileNBA = f"{PATH_NBA_GENO}/{ANCESTRY}/chr{chrom}_{ANCESTRY}_release{release}_vwb"
    inputRawFileWGS = f"{PATH_WGS_GENO}/{ANCESTRY}/chr{chrom}_{ANCESTRY}_release{release}"
